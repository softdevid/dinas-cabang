...
const ProfilPejabatEdit = ({ title, profilPejabat }) => {

  const [errors, setErorrs] = useState({});

  const [values, setValues] = useState({
    namaPejabat: profilPejabat.namaPejabat,
    jabatan: profilPejabat.jabatan,
    profil: profilPejabat.profil,
    pendidikan: profilPejabat.pendidikan,
    karir: profilPejabat.karir,
    penghargaan: profilPejabat.penghargaan,
    imgName: profilPejabat.imgName,
    imgUrl: profilPejabat.imgUrl,
  })
  console.log(values);
  ...
  function handleSubmit() {
    axios
      .patch(`/super-admin/pejabat/${profilPejabat.id}`, values)
      .then((res) => {
...
ProfilPejabatEdit.layout = (page) => <SuperAdminTemplate children={page} />
export default ProfilPejabatEdit;
