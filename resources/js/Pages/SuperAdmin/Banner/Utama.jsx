...
const Utama = (props) => {
  ...
  const [valuesEdit, setValuesEdit] = useState({
    imgName: props.banner.imgName,
    imgUrl: props.banner.imgUrl,
    deskripsi: props.banner.deskripsi,
    jenisBanner: props.banner.jenisBanner,
  })
