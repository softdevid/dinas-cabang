    ...
    return (
        <>
            ...
            <div className="mx-4 md:mx-52 md:my-20">
                ...
                <p className="text-center text-xl md:text-3xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias quasi vitae doloremque optio velit et consectetur aspernatur ipsum. Alias, corrupti.</p>
            </div>

            <div className="mx-4 md:mx-52 md:my-28">
                <h1 className="text-5xl text-blue-600 text-center my-10">Misi</h1>
                <li className="text-left text-xl md:text-3xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias quasi vitae doloremque optio velit et consectetur aspernatur ipsum. Alias, corrupti.</li>
                <li className="text-left text-xl md:text-3xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias quasi vitae doloremque optio velit et consectetur aspernatur ipsum. Alias, corrupti.</li>
                <li className="text-left text-xl md:text-3xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias quasi vitae doloremque optio velit et consectetur aspernatur ipsum. Alias, corrupti.</li>
                <li className="text-left text-xl md:text-3xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias quasi vitae doloremque optio velit et consectetur aspernatur ipsum. Alias, corrupti.</li>
            </div>
