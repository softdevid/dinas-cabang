...
const PrestasiEdit = ({ title, dataSekolah, prestasi }) => {
  const [errors, setErorrs] = useState({});

  const [values, setValues] = useState({
    idSekolah: prestasi.idSekolah,
    namaLomba: prestasi.namaLomba,
    kategoriLomba: prestasi.kategoriLomba,
    namaPeserta: prestasi.namaPeserta,
    statusPeserta: prestasi.statusPeserta,
    asalInstansi: prestasi.asalInstansi,
    penanggungJawab: prestasi.penanggungJawab,
    targetCapaian: prestasi.targetCapaian,
    jadwalPelaksanaan: prestasi.jadwalPelaksanaan,
    sumberAnggaran: prestasi.sumberAnggaran,
    tingkatPrestasi: prestasi.tingkatPrestasi,
  });
  ...
  function handleSubmit() {
    axios
      .patch(`/super-admin/prestasi/${prestasi.id}`, values)
      .then((res) => {
...
PrestasiEdit.layout = (page) => <SuperAdminTemplate children={page} />;
