...
const SosmedTambah = () => {
  ...
  function handleSubmit() {
    axios
      .post(`/super-admin/sosmed`, values)
      .then((res) => {
  ...
  return (
    <>
      <Head title="Tambah Sosmed" />
      <ToastContainer autoClose={2000} />
      <div className="grid grid-cols-2">
        <div>
          <h1 className="text-lg md:text-2xl">Tambah Sosmed</h1>
        </div>
...
SosmedTambah.layout = (page) => <SuperAdminTemplate children={page} />
export default SosmedTambah;
