      ...
      <footer className="bg-white dark:bg-gray-900 border-t-4 mt-5">
        <div className="mx-auto w-full container p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 text-center md:text-left md:grid-cols-2 lg:grid-cols-5 gap-8 ml-6">
              <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com/" className="flex items-center">
                  ...
                  <span className="self-center font-bold">{data.namaSuperAdmin}</span>
                </a>
              </div>
              <div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">2023 <a href="#" className="hover:underline">SoftDev Community Purbalingga</a>
            </span>
