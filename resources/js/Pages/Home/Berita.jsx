                    ...
                    <div className="max-w-xs md:max-w-sm mx-auto shadow-lg bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <div className="p-5">
                        ...
                        <div className="justify-center items-center flex mt-3">
                          <button onClick={() => handleOpen(data)} as="button" href="#" className="mx-auto inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Terus Membaca
  ...
  return (
    <>
      <div className="mx-2 md:mx-[100px]">
        <h1 className="text-center text-xl md:text-3xl font-bold my-4">{data.judulBerita}</h1>
        <img src={data.imgUrl} className="mx-auto w-full md:max-h-[550px] rounded-lg object-cover object-center aspect-video" />

        <p className="text-md md:text-lg">{data.deskripsi}</p>
      </div>
