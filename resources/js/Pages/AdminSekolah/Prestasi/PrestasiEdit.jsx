...
const PrestasiEdit = ({ title, dataPrestasi, dataSekolah }) => {
  ...
  const [values, setValues] = useState({
    ...
    namaLomba: dataPrestasi.namaLomba,
    kategoriLomba: dataPrestasi.kategoriLomba,
    namaPeserta: dataPrestasi.namaPeserta,
    statusPeserta: dataPrestasi.statusPeserta,
    asalInstansi: dataSekolah.namaSekolah,
    penanggungJawab: dataPrestasi.penanggungJawab,
    targetCapaian: dataPrestasi.targetCapaian,
    jadwalPelaksanaan: dataPrestasi.jadwalPelaksanaan,
    sumberAnggaran: dataPrestasi.sumberAnggaran,
    tingkatPrestasi: dataPrestasi.tingkatPrestasi,
  });
  ...
  function handleSubmit() {
    axios
      .patch(`/admin-sekolah/${dataSekolah.id}/prestasi/${dataPrestasi.id}`, values)
      .then((res) => {
...
PrestasiEdit.layout = (page) => <AdminSekolahLayout children={page} />;
