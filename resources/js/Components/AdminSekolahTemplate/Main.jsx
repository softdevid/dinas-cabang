        ...
        <>
            ...
            <div className="block md:hidden">
                ...
                <div id="drawer-navigation" className="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-gradient-to-t from-sky-700 via-blue-700 to-cyan-500 w-80 dark:bg-gray-800" tabIndex="-1" aria-labelledby="drawer-navigation-label">
                    <h5 id="drawer-navigation-label" className="text-base font-semibold text-white uppercase dark:text-gray-400">Menu - Sekolah ...</h5>
                    ...
                    <div className="py-4 overflow-y-auto">
                        <ul className="space-y-2">
                            ...
                            <>
                                <li>
                                    <Link href="/sekolah/dashboard" className="flex items-center p-2 text-base font-normal text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <ComputerDesktopIcon className="h-6 w-6" />
                                        <span className="ml-3">Dashboard</span>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/sekolah/prestasi" className="flex items-center p-2 text-base font-normal text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <li>
                                <Link href="/sekolah/artikel" className="flex items-center p-2 text-base font-normal text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <NewspaperIcon className="h-6 w-6" />
                                    <span className="ml-3">Artikel</span>
                                </Link>
                            </li>
                            <li>
                                <Link href="/sekolah/profil" className="flex items-center p-2 text-base font-normal text-white hover:text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
