    ...
    <>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-2 gap-4 md:gap-8 my-8 md:mx-[90px]">
        {props.berita.map((data, i) => {
          return (
            <div key={i} className="max-w-xs md:max-w-sm mx-auto shadow-lg bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
              <img className="rounded-t-lg h-[280px] w-[380px] object-cover object-top mx-auto" src={data.imgUrl} alt="" />
              <div className="p-5">
