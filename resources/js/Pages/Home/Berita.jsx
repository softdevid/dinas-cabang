...
import { CalendarDaysIcon, ClockIcon, NewspaperIcon, PencilSquareIcon } from "@heroicons/react/20/solid";
        ...
        <>
            ...
            <form className="w-80 mx-auto m-5">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari berita pendidikan" required />
                    ...
                    <div className="p-5">
                        <div className="grid grid-cols-2 gap-4 mb-2">
                            <div className="flex" title="Waktu Posting">
                                <CalendarDaysIcon className="w-5 h-5" /> <b className="text-xs ml-2">12-12-2023, 10:50:05</b>
                            </div>
                            <div className="flex text-right" title="Nama Penulis">
                                <PencilSquareIcon className="w-5 h-5" /> <b className="text-xs ml-2">Ardianto Putra</b>
                            </div>
